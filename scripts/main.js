...
function callUs(e) {
    try {
        window.location.href = 'tel:08039694639';
    } catch (ee) { }
}
...
var ChannelNames = ["MobileNigeria", "Vanguard", "Punch",
"Nation", "LindaIkeji", "Sun", "TVC", "TheNET", "360Nobs", "Naij",
"Channels TV", "CNN", "BBC", "Info Nigeria", "Leadership",
"DailyPost", "PM", "Complete Sports", "Goal.com", "TechCrunch",
"TechLoy", "OTEKBITS", "Ladun Liadi", "OgbongeBlog", 'Premium Times',

"Y! Naija", "Sahara", "Guardian", "BellaNaija", "TechCrunch",
"Redeemed"];

var ChannelIcons = ["mobilelagos.png", "vanguard.jpg",
...
"otekbits.png", "ladunlaidi.png", "ogbongeblog.png", "mobilelagos.png",

"ynaija.png", "saharareporters.png", "guardiannews.png",
"BellaNaija-logo.png", "techcrunch.png", "iamredeemed.png"];
    ...
    $("#twittermenu").kendoMobileListView({
        dataSource: new kendo.data.DataSource({
            data: [{ name: "@MobileNigeria", img: "img/icon.png", id: 1 },
                 { name: "Trendings #MobileNigeria", img: "img/trending-tweets.png", id: 2 }]
        }),
        template: $("#menutemplate").text(),
        click: function (e) {
...
function prevent(e) {
    if (activePage == 'news') {
        ...
        $('#menu').data('title', 'News Sources');
        $('#menutitle').text('News Sources');
    }
